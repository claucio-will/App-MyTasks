...
import com.example.mytasks.adapter.ViewPageAdapter
import com.example.mytasks.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    private fun logoutApp(){
     auth.signOut()
     findNavController().navigate(R.id.action_homeFragment_to_authNavigation)
    }
